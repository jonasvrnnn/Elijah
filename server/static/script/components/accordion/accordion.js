class CustomAccordion extends HTMLElement {
    ...
    render() {
        ...
        this.items.forEach((item, title_index) => {
            ...
            title_element.classList.add("title-wrapper");
            ...
            title.addEventListener("click", () => this.go_to_index(i));
            ...
            this.title_list.appendChild(title_element);
    ...
    go_to_index(index) {
        ...
        Array.from(titles).forEach((title, i) => title.toggleAttribute("selected", index === i));
