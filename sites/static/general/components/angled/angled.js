class AngledElement extends HTMLElement {
    constructor() {
        ...
        this.triangle_bottom = true;

        this.triangle_top_position = ".5";
        this.triangle_bottom_position = ".125";

        this.triangle_top_size = 0;
        this.triangle_bottom_size = 60;
    ...
    attributeChangedCallback(name, oldValue, newValue) {
        switch (name) {
            ...
            case "triangle-top": this.triangle_top = newValue != undefined; break;
            case "triangle-bottom": this.triangle_bottom = newValue != undefined; break;

            case "triangle-top-position": this.triangle_top_position = newValue;
            case "triangle-bottom-position": this.triangle_bottom_position = newValue;
    ...
    calculate_triangle_dimensions(angle, triangle_size) {
        ...
        const diagonal_large = distance_to_corner / this.cos(angle);

        const diagonal_small = (top_height / this.sin(135 - (90 - angle))) * this.sin(45);

        const factor = diagonal_small / diagonal_large;
    ...
    process_side(top, affected_children) {
        ...
        const triangle = top && this.triangle_top || !top && this.triangle_bottom;
